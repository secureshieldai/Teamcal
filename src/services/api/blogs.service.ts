...
export const blogsService={
 ...
 async createArticle(value:{blogId:string;title:string;body:string;cover?:string;category?:string;status?:string}){const {data}=await apiClient.post<{success:boolean;article:BlogArticle}>('/blogs/articles',value);return data.article;},
