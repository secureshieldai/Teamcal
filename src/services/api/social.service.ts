...
export type SocialBlog={id:string;blog_id:string;title:string;cover?:string;body?:string;excerpt?:string;category?:string;read_minutes:number;views:number;created_at:string;user?:{id:string;name:string;avatar:string|null;verified:boolean}};
