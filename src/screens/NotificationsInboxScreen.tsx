...
const icons: Record<string, keyof typeof Ionicons.glyphMap> = { like: 'heart', comment: 'chatbubble', friend: 'person-add', follow: 'people', order: 'bag-handle', reward: 'gift' };
...
export default function NotificationsInboxScreen() {
  ...
  const open = async (item: AppNotification) => { if (!item.read) { await notificationsService.markRead(item.id); query.refetch(); } };
