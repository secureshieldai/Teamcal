...
import { referralSummary, referralList, referralProgramDetails, type DateRangeKey } from '../../data/earnData';
  ...
  return (
    <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.statsRow}>
        <StatCard label="Total Referrals" value={referralSummary.totalReferrals.toLocaleString()} icon="people-outline" size="lg" />
        <StatCard label="Total Earnings" value={`$${referralSummary.totalEarnings.toLocaleString(undefined, { minimumFractionDigits: 2 })}`} icon="cash-outline" size="lg" />
      </View>
      <View style={{ marginTop: spacing.sm }}>
        <StatCard label="Conversion Rate" value={`${referralSummary.conversionRate}%`} icon="trending-up-outline" size="lg" />
      </View>
      ...
      <View style={styles.inviteCard}>
        ...
        <View style={styles.fieldCard}>
          ...
          <View style={styles.fieldRow}>
            ...
            <TouchableOpacity style={styles.copyBtn} onPress={() => copyToClipboard(referralSummary.referralLink, 'Referral link')}>
        ...
        <View style={styles.fieldCard}>
          ...
          <View style={styles.fieldRow}>
            <Text style={styles.fieldValue}>{referralSummary.referralCode}</Text>
            <TouchableOpacity style={styles.copyBtn} onPress={() => copyToClipboard(referralSummary.referralCode, 'Referral code')}>
        ...
        <View style={styles.shareRow}>
          {SHARE_CHANNELS.map((channel) => (
            <TouchableOpacity
              ...
              onPress={() => Share.share({ message: `Join me on TeamCal: ${referralSummary.referralLink}` })}
            >
