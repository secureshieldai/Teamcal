...
const showcase:Item[]=[{title:'High-Protein Breakfast Bowl',details:'Greek yogurt, berries, oats and seeds.'},{title:'15-Minute Veggie Stir-Fry',details:'Mixed vegetables, tofu and a light sesame sauce.'},{title:'Mediterranean Chickpea Salad',details:'Chickpeas, cucumber, tomato, herbs and lemon.'}];
...
export default function PersonalToolScreen({route,navigation}:Props){
 ...
 const titleText=kind==='recipe-library'?'Recipe Library':kind==='my-recipes'?'My Recipes':'Period Tracker';const data=kind==='recipe-library'?showcase:records.map(r=>r.data);
